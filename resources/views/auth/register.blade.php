				...
				<div class="panel-body">
                        <form method="POST" action="{{ route('register') }}" autocomplete="off">
                            ...
                            <fieldset>
                                ...
                                <div class="row mb-3">
                                    <label class="form-label col-form-label col-md-3">Área</label>
                                    <div class="col-md-9">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="email" value="{{ old('folio') }}" placeholder="Correo Electrónico" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="form-label col-form-label col-md-3">Confirma Contraseña</label>
                                    <div class="col-md-9">
