...
@section('title', 'Fuente '.$fuente->nombre)
...
$(function () {
	...
	var table = $('#dataTableObras').DataTable({
                ajax: "{{ route('obrasDeFuente.list', ['id' => $fuente->id]) }}",
                serverSide: true,
                processing: true,
                columns: [
					{data: 'pgo', name: 'pgo'},
            ...
            @if ($errors->any())
                ...
                var response = "<ul>@foreach ($errors->all() as $error)<li>{{ $error }}</li>@endforeach</ul>"

                $('#modalErrores .modal-body').html(response);
...
@section('content')
	...
	<!-- BEGIN page-header -->
	<h1 class="page-header">Fuente <small>Información General</small></h1>
	<!-- END page-header -->
		...
		<div class="col-xl-12">
			...
			<div class="panel panel-inverse" data-sortable-id="index-1">
				<div class="panel-heading">
					<h4 class="panel-title">Fuente</h4>
	...
	<div class="row">
		...
		<div class="col-xl-12">
			...
			<div class="panel panel-inverse" data-sortable-id="index-1">
				<div class="panel-heading">
					<h4 class="panel-title">Obras de la Fuente {{ $fuente->nombre }}</h4>
					<div class="panel-heading-btn">
						<a href="javascript:;" class="btn btn-xs btn-icon btn-default" data-toggle="panel-expand"><i class="fa fa-expand"></i></a>
						<a href="javascript:;" class="btn btn-xs btn-icon btn-warning" data-toggle="panel-collapse"><i class="fa fa-minus"></i></a>
					</div>
