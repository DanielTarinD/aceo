...
$(function () {
	...
	var table = $('#dataTableAreas').DataTable({
...
@section('content')
	...
	<!-- BEGIN page-header -->
	<h1 class="page-header">Áreas <small>Lista</small></h1>
	<!-- END page-header -->
							...
							<div class="widget widget-stats bg-teal">
								...
								<div class="stats-content">
									...
									<div class="stats-link">
										<a href="/catalogos/areas/create" class="btn btn-primary">Nueva Área <i class="fa fa-arrow-alt-circle-right"></i></a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="panel panel-inverse" data-sortable-id="index-1">
				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="dataTableAreas" width="100%" cellspacing="0">
							<colgroup>
								<col style="width: 40%;">
								<col style="width: 40%;">
								<col style="width: 20%;">
